...
Defined in `keybinding::defaults()`, using vim-style spatial motions:
...
each option. Action names use kebab-case with direction suffixes
(`focus-left`, `move-right`, etc.). Modifier names are lowercase.
